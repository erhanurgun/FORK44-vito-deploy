<div x-data="">
    <button type="button" class="flex items-center" x-on:click="$dispatch('open-modal', 'create-tag-modal')">
        ...
        <span class="text-md">{{ __('New Tag') }}</span>
    </button>
    @push("footer")
        <x-modal name="create-tag-modal" max-width="sm">
            <form
                ...
                class="p-6"
            >
                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('New Tag') }}</h2>
                ...
                <div class="mt-6 flex justify-end">
                    ...
                    <x-primary-button class="ml-3" hx-disable>{{ __('Save') }}</x-primary-button>
                </div>
